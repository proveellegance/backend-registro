...
const Login = () => {
  ...
  return (
    <div className="min-h-screen" style={{background: 'linear-gradient(135deg, #b28e5c 0%, #9d2148 100%)'}}>
      ...
      {/* Contenido principal - mismo estilo que dashboard */}
      <main className="container mx-auto px-6 py-16 md:py-24 pb-64 md:pb-80">
        <div className="space-y-16 md:space-y-20">
          ...
          <div className="flex justify-center animate-fade-in delay-300">
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl shadow-2xl p-12 border border-gray-100 max-w-lg w-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-2xl focus:border-primary-burgundy focus:ring-4 focus:ring-primary-burgundy focus:ring-opacity-20 transition-all duration-200 text-lg"
                      required
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="•••••••••••"
                      className="w-full pl-12 pr-16 py-4 border-2 border-gray-200 rounded-2xl focus:border-primary-burgundy focus:ring-4 focus:ring-primary-burgundy focus:ring-opacity-20 transition-all duration-200 text-lg"
                      required
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
                      className="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-primary-burgundy transition-colors duration-200"
                    >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-primary-burgundy to-primary-gold text-white py-4 px-8 rounded-2xl 
                           hover:scale-[1.02] transform transition-all duration-300 shadow-xl hover:shadow-2xl 
                           disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none
                           focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-50 text-lg font-semibold"
                >
                  {loading ? (
