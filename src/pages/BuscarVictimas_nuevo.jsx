  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              {columnas.map(columna => (
                <div key={columna} className="form-group">
                  ...
                  <input
                    ...
                    placeholder={`Buscar por ${columna.replace(/_/g, ' ')}`}
                  />
                </div>
              ))}
            </div>
        ...
        {/* No results message */}
        {!cargando && resultados.length === 0 && Object.values(filtros).some(f => f.trim()) && (
          <div className="card-modern p-12 text-center animate-fade-in">
            ...
            <p className="text-gray-500">
              No se encontraron registros que coincidan con los criterios de búsqueda aplicados
            </p>
            <p className="text-gray-400 text-sm mt-2">
              Intenta ajustar los filtros o utilizar términos de búsqueda más amplios
            </p>
          </div>
        )}
      </div>
